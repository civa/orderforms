...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div id="slider-contentbox" class="col-md-9 pull-md-left">
        ...
        <div class="range_slider2_input">
                ...
                {foreach $products as $key => $p}
                    <div id="product_stats_{$p@iteration}" class="product_stats price_content" style="display: none;">
                        <div class="pricing_listingbox">
                        <div class="price-box-section col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">

                            <div class="price_box_action_hoverbox">
                            <div class="price_box_action">
                        ...
                        <!-- features description  if defined any featured defined -->
                            ...
                            <div class="slider_contentlisting_box">
                                <div class="price_box_action_hoverbox">
                        ...
                        <div class="order_pricebar">
                            <div class="order_pricebar_inner">
        ...
        <div id="mySidebar" class="pull-md-right sidebar custom-sidebar">
...
<script src="/js/cutom-js.js"></script>
<script type="text/javascript">
    ...
    function openNav() {
        if (toggle == false)
        {
            ...
            document.getElementById("slider-contentbox").style.marginRight="300px";
            toggle = true;
        }
        else
        {
            document.getElementById("mySidebar").style.width = "0";
            document.getElementById("slider-contentbox").style.marginRight ="0";
            toggle = false;
        }
    }
